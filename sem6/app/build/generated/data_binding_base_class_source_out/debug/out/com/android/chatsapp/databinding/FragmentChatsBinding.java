...
public final class FragmentChatsBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView chatsRecycleView;

  private FragmentChatsBinding(@NonNull FrameLayout rootView,
      @NonNull RecyclerView chatsRecycleView) {
    this.rootView = rootView;
    this.chatsRecycleView = chatsRecycleView;
  }
  ...
  public static FragmentChatsBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.chatsRecycleView;
      RecyclerView chatsRecycleView = ViewBindings.findChildViewById(rootView, id);
      if (chatsRecycleView == null) {
        break missingId;
      }

      return new FragmentChatsBinding((FrameLayout) rootView, chatsRecycleView);
    }
